DROP FUNCTION arc_energo.dadata_address(integer, varchar);

CREATE OR REPLACE FUNCTION arc_energo.dadata_address(
    IN arg_kod integer,
...
return ret_flg, ret_addr_city, ret_addr_city_code, ret_addr_street, ret_addr_street_type, ret_addr_house, ret_addr_block, ret_addr_flat
$BODY$
